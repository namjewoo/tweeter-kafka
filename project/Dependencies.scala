...
object Dependencies {
  ...
  var akka =                    "com.typesafe.akka" %% "akka-stream-kafka" % "0.16"
  var akkaConsumer   = "org.apache.kafka" % "kafka-clients" % "0.11.0.0"
  var kafkaStreaming = "org.apache.kafka" % "kafka-streams" % "0.11.0.0"
  var akkaStream  = "com.typesafe.akka" %% "akka-stream" % "2.5.4"
  var akkaStreamKafka = "com.typesafe.akka" %% "akka-stream-kafka" % "0.11-RC1"
  var akkaActor   = "com.typesafe.akka" %% "akka-actor" % "2.5.4"
}